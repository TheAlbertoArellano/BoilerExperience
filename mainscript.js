...
const subjectElements = document.querySelectorAll('.subject'); // Assuming subject elements have the class 'subject'

// Function to display courses based on subject
function displayCourses(subject) {
    ...
    if (courses[subject]) {
        courses[subject].forEach(course => {
            ...
            courseDiv.setAttribute('data-subject', subject); // Set subject for color coding
...
// Event listeners for subject grids
subjectElements.forEach(subjectElement => {
    subjectElement.addEventListener('click', () => {
        const subject = subjectElement.getAttribute('data-subject'); // Get the subject from data attribute
        displayCourses(subject);
    });
});

// Optionally, load all courses initially (uncomment if needed)
loadAllCourses();
